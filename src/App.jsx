      ...
      <BrowserRouter>
        ...
        <Main>
          <Routes>
            ...
            <Route
              element={<UserPrivateRoute permission={"readAll-emailConfig"} />}
            >
              <Route
            ...
            >
              <Route path="/admin/attendance" element={<GetAllAttendance />} />
            </Route>
            ...
            {/* === === === Announcement Routes === === === */}
            <Route
              element={<UserPrivateRoute permission={"readAll-announcement"} />}
            >
              <Route
